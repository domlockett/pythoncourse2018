...
#### In class practice
## NOTES##
#SCOPE: python is first going to look into your function for the object you calkl. 
## classses have certain attributres and methods
    #class is the definition and a particular instance of the class is called an instance
...
class Bill():
  ...
  def result(self):
      if (len(self.votes["yes"]) > len(self.votes["no"])): self.passed = True
