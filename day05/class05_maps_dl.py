...
import imp
import googlemaps
imported_items = imp.load_source('C:\Python27.14\pythoncourse2018\day05', 'C:\Python27.14\KEYS\googlekeys.py')
...
# Draw
plot1.draw("C:/Python27.14/pythoncourse2018/day05/my_map.html")
