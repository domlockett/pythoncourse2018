...
download_page('https://polisci.wustl.edu/faculty/specialization', "C:/Python27.14/pythoncourse2018/polisci_ppl.html")

## You can also parse a page that is saved on your computer
## Useful to scrape now, parse later.
with open("C:/Python27.14/pythoncourse2018/polisci_ppl.html") as f:
  myfile = f.read()
